...
type
  TfrmRelatorio = class(TForm)
    ...
    ppLine2: TppLine;
    ppLine3: TppLine;
    qryRelcidadeEstado: TStringField;
...
begin
  ...
  qryRel.Close;
  qryRel.SQL.Clear;
  qryRel.SQL.Add('Select cli.CODIGO_CLIENTE,cli.CGC_CPF_CLIENTE,cli.nome as nome_cliente,cli.telefone,cli.endereco,cli.bairro,cli.cep,cid.nome as nome_cidade,cid.nome+ '' - '' + cid.estado as cidadeEstado from clientes cli');
