object frmRelatorio: TfrmRelatorio
  ...
  object GroupBox1: TGroupBox
    ...
    object edtClienteInicio: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnKeyPress = edtClienteInicioKeyPress
    end
    object edtClienteFinal: TEdit
      ...
      ParentFont = False
      TabOrder = 1
      OnKeyPress = edtClienteFinalKeyPress
    end
  end
  object GroupBox2: TGroupBox
    ...
    object edtCidadeInicio: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnKeyPress = edtCidadeInicioKeyPress
    end
    object edtCidadeFinal: TEdit
      Left = 144
      Top = 39
      Width = 90
      Height = 22
      ...
      ParentFont = False
      TabOrder = 1
      OnKeyPress = edtCidadeFinalKeyPress
    end
  end
  ...
  object qryRel: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select cli.CODIGO_CLIENTE,cli.CGC_CPF_CLIENTE,cli.nome as nome_c' +
        'liente,cli.telefone,cli.endereco,cli.bairro,cli.cep,cid.nome as ' +
        'nome_cidade,cid.nome+ '#39' - '#39' + cid.estado as cidadeEstado from cl' +
        'ientes cli'
      'inner join cidades cid on cid.CODIGO_CIDADE = cli.CODIGO_CIDADE'
      'Where 1 = 1')
    Left = 504
    Top = 48
    object qryRelCODIGO_CLIENTE: TAutoIncField
      FieldName = 'CODIGO_CLIENTE'
      ReadOnly = True
    end
    object qryRelCGC_CPF_CLIENTE: TStringField
      FieldName = 'CGC_CPF_CLIENTE'
      Size = 14
    end
    object qryRelnome_cliente: TStringField
    ...
    object qryRelcidadeEstado: TStringField
      FieldName = 'cidadeEstado'
      ReadOnly = True
      Size = 105
    end
    object qryRelnome_cidade: TStringField
  ...
  object ppRelCidadeAgrupada: TppReport
    AutoStop = False
    DataPipeline = ppRel
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    ...
    PrinterSetup.mmPaperWidth = 210000
    PrinterSetup.PaperSize = 9
    AfterPrint = ppRelCidadeAgrupadaAfterPrint
    ArchiveFileName = '($MyDocuments)\ReportArchive.raf'
    DeviceType = 'Screen'
    DefaultFileDeviceType = 'PDF'
    EmailSettings.ReportFormat = 'PDF'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel15: TppLabel
        ...
        UserName = 'Label1'
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio agrupado por cidade'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 14
